...
const GenerateAttendanceReportInputSchema = z.object({
  workLogs: z
    .string()
    .describe('A detailed work log including labour names, work descriptions, and locations.'),
...
const generateAttendanceReportPrompt = ai.definePrompt({
  ...
  Based on the provided information, generate a comprehensive daily attendance report, ensuring to verify labour presence and activities.
